        ...
        public static void FindNoteDirection(List<Cube> cubes, List<BaseNote> bombs, float bpm)
        {
            if (cubes[0].Assumed)
            {
                ...
                if (c != null)
                {
                    ...
                    {
                        var a = DirectionToDegree[c.Note.CutDirection] + c.Note.AngleOffset;
                        if (a >= 360)
                        {
                            a -= 180;
                        }
            ...
            {
                var a = DirectionToDegree[cubes[0].Note.CutDirection] + cubes[0].Note.AngleOffset;
                if (a >= 360)
                {
                    a -= 180;
                }
            ...
            for (int i = 1; i < cubes.Count(); i++)
            {
                ...
                {
                    var a = DirectionToDegree[cubes[i].Note.CutDirection] + cubes[i].Note.AngleOffset;
                    if (a >= 360)
                    {
                        a -= 180;
                    }
