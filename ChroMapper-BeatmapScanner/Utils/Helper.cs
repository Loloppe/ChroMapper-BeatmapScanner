    ...
    internal class Helper
    {
        ...
        public static void FixPatternHead(List<Cube> cubes)
        {
            for (int j = 0; j < 3; j++)
            {
                ...
                {
                    double temp = DirectionToDegree[cubes[i].Note.CutDirection] + cubes[i].Note.AngleOffset;

                    if (cubes[i].Note.CutDirection == 8)
                    {
                        if (cubes[i].Beat - cubes[i - 1].Beat <= 0.02 && cubes[i].Beat - cubes[i - 1].Beat >= -0.02)
                        {
                            if (cubes[i - 1].Note.CutDirection != 8)
                            {
                                temp = DirectionToDegree[cubes[i - 1].Note.CutDirection] + cubes[i - 1].Note.AngleOffset;
                            }
                        }
                    ...
                    if (cubes[i].Note.Time == cubes[i - 1].Note.Time)
                    {
                        switch (temp)
                        {
        ...
        public static void FindNoteDirection(List<Cube> cubes, List<BaseNote> bombs, float bpm)
        {
            if (cubes[0].Note.CutDirection == 8)
            {
                ...
                if (c != null)
                {
                    cubes[0].Direction = DirectionToDegree[c.Note.CutDirection] + c.Note.AngleOffset;
            ...
            {
                cubes[0].Direction = DirectionToDegree[cubes[0].Note.CutDirection] + cubes[0].Note.AngleOffset;
            }
            ...
            for (int i = 1; i < cubes.Count(); i++)
            {
                ...
                bo = bombs.LastOrDefault(b => cubes[i - 1].Beat < b.Time && cubes[i].Beat >= b.Time && cubes[i].Line == b.PosX);
                ...
                {
                    cubes[i].Direction = DirectionToDegree[cubes[i].Note.CutDirection] + cubes[i].Note.AngleOffset;
                }
            }
        }
